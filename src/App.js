...
Auth0.configure({
  domain: 'jerdo.eu.auth0.com',
  clientID: 'O5nwv1L0dqKS3LKtwROj8N0zkp52vH4I',
  redirectUri: 'http://localhost:3000/',
  responseType: 'token id_token',
  scope: 'openid profile manage:points',
  audience: 'https://jerdo1game.web.app/',
});
...
class App extends Component {
  ...
  componentDidMount() {
    ...
    window.onresize = () => {
      const cnv = document.getElementById('Jerdo-game-canvas');
